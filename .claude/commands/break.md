...
5. Stage all changes (`git add -A`), commit with a short message summarizing the session, and push to whatever branch we are currently on or whatever branch the user explicitly says to push to in message.